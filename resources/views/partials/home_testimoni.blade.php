        ...
        <div class="section-heading text-center">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <h2>Testimoni</h2>
                    <p>Beberapa testimonial dari mereka yang telah mempercayakan Kami sebagai Teman Perjalanan Ibadah</p>
                </div>
            </div>
        </div>
        <br />
            <div class="row">
                ...
                <div class="col-md-4">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/CJcCID8-6r4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
    </div>
</section>
